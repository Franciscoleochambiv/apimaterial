...
router.get("/producto", (req, res) => {
  ...
  console.log(req.body);
  req.getConnection((err, conn) => {
    conn.query('select articulos.id,articulos.codigo,articulos.imagen, articulos.descripcion,Categorias.descripcion as category,detalle,articulos.precio from articulos inner join Categorias on Categorias.Categoria=articulos.grupo inner join existencias on existencias.codigo=articulos.codigo', (err, customers) => {  
        if (err) {
            res.json(err);
        }
